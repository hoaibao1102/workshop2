        ...
        try {
            if ("viewExamsByCategory".equals(action)) {
                ...
                if (questionText == null || questionText.trim().isEmpty()) {
                    request.setAttribute("errorQuestion", "Question is required.");
                    valid = false;
                }
                if (a == null || a.trim().isEmpty()) {
                    request.setAttribute("errorA", "Option A is required.");
                    valid = false;
                }
                if (b == null || b.trim().isEmpty()) {
                    request.setAttribute("errorB", "Option B is required.");
                    valid = false;
                }
                if (c == null || c.trim().isEmpty()) {
                    request.setAttribute("errorC", "Option C is required.");
                    valid = false;
                }
                if (d == null || d.trim().isEmpty()) {
                    request.setAttribute("errorD", "Option D is required.");
                    valid = false;
                }
                ...
                double score = correctNum / total * 100;
